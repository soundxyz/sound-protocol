...
import { ISuperMinterE } from "@modules/interfaces/ISuperMinterE.sol";
...
/**
 * @title SuperMinterE
 * @dev The `SuperMinterE` class is a generalized minter that also supports ERC20 tokens.
 */
contract SuperMinterE is ISuperMinterE, EIP712 {
    using LibBitmap for *;
    ...
    struct MintData {
        ...
        bytes32 merkleRoot;
        // The ERC20 token to denominate the fees in.
        address erc20;
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual returns (bool) {
        return
            LibOps.or(interfaceId == type(ISuperMinterE).interfaceId, interfaceId == this.supportsInterface.selector);
    }
