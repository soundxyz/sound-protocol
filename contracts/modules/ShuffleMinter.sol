...
import { EditionMaxMinter} from "./EditionMaxMinter.sol";
...
/*
 * @title ShuffleMinter
 * @notice Module for minting with the RarityShuffleMetadata module
 * @author ipatka
 */
contract ShuffleMinter is EditionMaxMinter{
    // =============================================================
    //                            STORAGE
    // =============================================================
