 ...
 * @dev Interface for the `FixedPriceSignatureMinterV2_1` module.
 * @author Sound.xyz
 */
interface IFixedPriceSignatureMinterV2_1 is IMinterModuleV2_1 {
    // =============================================================
    //                            EVENTS
    // =============================================================
    ...
    /**
     * @dev Returns IFixedPriceSignatureMinterV2_1.MintInfo instance containing the full minter parameter set.
