...
/**
 * @title IEditionMaxMinterV2
 * @dev Interface for the `EditionMaxMinterV2` module.
 * @author Sound.xyz
 */
interface IEditionMaxMinterV2 is IMinterModuleV2 {
    // =============================================================
    //                            EVENTS
    // =============================================================
    ...
    /**
     * @dev Returns {IEditionMaxMinterV2.MintInfo} instance containing the full minter parameter set.
