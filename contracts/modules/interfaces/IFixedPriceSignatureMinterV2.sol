 ...
 * @dev Interface for the `FixedPriceSignatureMinterV2` module.
 * @author Sound.xyz
 */
interface IFixedPriceSignatureMinterV2 is IMinterModuleV2 {
    // =============================================================
    //                            EVENTS
    // =============================================================
     ...
     * @param signer  The address of the signer that authorizes mints.
     */
    event SignerSet(address indexed edition, uint128 mintId, address signer);
    ...
    /**
     * @dev Returns IFixedPriceSignatureMinterV2.MintInfo instance containing the full minter parameter set.
