...
/**
 * @title IMerkleDropMinterV2
 * @dev Interface for the `MerkleDropMinterV2` module.
 * @author Sound.xyz
 */
interface IMerkleDropMinterV2 is IMinterModuleV2 {
    // =============================================================
    //                            EVENTS
    // =============================================================
    ...
    /**
     * @dev Returns IMerkleDropMinterV2.MintInfo instance containing the full minter parameter set.
