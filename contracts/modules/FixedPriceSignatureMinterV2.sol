...
import { IFixedPriceSignatureMinterV2, EditionMintData, MintInfo } from "./interfaces/IFixedPriceSignatureMinterV2.sol";
import { IMinterModuleV2 } from "@core/interfaces/IMinterModuleV2.sol";
import { ISoundEditionV1 } from "@core/interfaces/ISoundEditionV1.sol";

/**
 * @title IFixedPriceSignatureMinterV2
 * @dev Module for fixed-price, signature-authorized mints of Sound editions.
 * @author Sound.xyz
 */
contract FixedPriceSignatureMinterV2 is IFixedPriceSignatureMinterV2, BaseMinterV2 {
    ...
    /**
     * @inheritdoc IFixedPriceSignatureMinterV2
     */
    ...
    function supportsInterface(bytes4 interfaceId) public view override(IERC165, BaseMinterV2) returns (bool) {
        return
            BaseMinterV2.supportsInterface(interfaceId) ||
            interfaceId == type(IFixedPriceSignatureMinterV2).interfaceId;
    }
    ...
    function moduleInterfaceId() public pure returns (bytes4) {
        return type(IFixedPriceSignatureMinterV2).interfaceId;
    }
