...
contract TestConfig is Test {
    ...
    function setUp() public virtual {
        ...
        MockSoundEditionV1a soundEditionImplementation = new MockSoundEditionV1a();
    ...
    function createModule() internal returns(address, address) {
        ...
        return (address(module), predictedSoundAddress);
    ...
    function createSound(
      ...
      (address module, address predicted) = createModule();
    ...
    function createGenericEdition() public returns (SoundEditionV1a) {
        return
            SoundEditionV1a(
                createSound(
                    SONG_NAME,
