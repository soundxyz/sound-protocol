...
contract MerkleDropMinterTests is TestConfig {
    ...
    function test_mintToDifferentAddress() external {
        ...
        unchecked {
            ...
            for (uint256 i; i < accounts.length; ++i) {
                ...
                minter.mint(address(edition), mintId, to, uint32(quantity), proof, address(0), 0);
    ...
    function test_canMintMultipleTimesLessThanMaxMintablePerAccount() public {
        ...
        vm.prank(accounts[1]);
        minter.mint(address(edition), mintId, accounts[1], requestedQuantity, proof, address(0), 0);
    ...
    function test_cannotClaimMoreThanMaxMintablePerAccount() public {
        ...
        minter.mint(address(edition), mintId, accounts[0], requestedQuantity, proof, address(0), 0);
    }
    ...
    function test_cannotClaimMoreThanMaxMintable() public {
        ...
        minter.mint(address(edition), mintId, address(this), requestedQuantity, proof, address(0), 0);
    }
