...
contract FixedPriceSignatureMinterTests is TestConfig {
    ...
    function _createEditionAndMinter() internal returns (SoundEditionV1_2 edition, FixedPriceSignatureMinter minter) {
    ...
    function test_mintRevertsIfBuyerNotAuthorized() public {
        (SoundEditionV1_2 edition, FixedPriceSignatureMinter minter) = _createEditionAndMinter();
