...
contract MintControllerBaseTests is TestConfig {
    ...
    function test_createEditionMintRevertsIfCallerNotEditionOwnerOrAdmin() external {
        ...
        vm.expectRevert(MinterBase.Unauthorized.selector);
        vm.prank(attacker);
    ...
    function test_mintRevertsForWrongEtherValue() public {
        ...
        uint256 price = 1;
        vm.expectRevert(abi.encodeWithSelector(MinterBase.WrongEtherValue.selector, price * 2 - 1, price * 2));
    ...
    function test_mintRevertsWhenPaused() public {
        ...
        uint256 price = 1;
        vm.expectRevert(MinterBase.MintPaused.selector);
