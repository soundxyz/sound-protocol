...
contract FixedPricePermissionedSaleMinterTests is TestConfig {
    ...
    function test_mintWithWrongEtherValueReverts() public {
        ...
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(MinterBase.WrongEtherValue.selector, PRICE * 2, PRICE));
    ...
    function test_mintWhenSoldOutReverts() public {
        ...
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(MinterBase.MaxMintableReached.selector, MAX_MINTABLE));
