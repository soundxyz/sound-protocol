...
export interface BaseMinterInterface extends utils.Interface {
  functions: {
...
export interface BaseMinter extends BaseContract {
  contractName: "BaseMinter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseMinterInterface;
