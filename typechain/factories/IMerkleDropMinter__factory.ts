...
import type {
  IMerkleDropMinter,
  IMerkleDropMinterInterface,
} from "../IMerkleDropMinter";
...
export class IMerkleDropMinter__factory {
  static readonly abi = _abi;
  static createInterface(): IMerkleDropMinterInterface {
    return new utils.Interface(_abi) as IMerkleDropMinterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IMerkleDropMinter {
    return new Contract(address, _abi, signerOrProvider) as IMerkleDropMinter;
  }
}
