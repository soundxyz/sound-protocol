...
export interface IMinterModuleInterface extends utils.Interface {
  functions: {
...
export interface IMinterModule extends BaseContract {
  contractName: "IMinterModule";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMinterModuleInterface;
