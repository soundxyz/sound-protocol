...
export interface IFixedPriceSignatureMinterInterface extends utils.Interface {
  functions: {
...
export interface IFixedPriceSignatureMinter extends BaseContract {
  contractName: "IFixedPriceSignatureMinter";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFixedPriceSignatureMinterInterface;
